    ...
    return(
            ...
            <div className="row" id="overflow">
                {store.vehiculos.map((vehicle, index)=>{
                    ...
                    return <Card key={vehicle.name} title={vehicle.name} index={id} caracteristica1={"cargo-capacity:"+ " " + vehicle.cargo_capacity} caracteristica2={"models:"+ " " + vehicle.model} caracteristica3={"cost in credits:" + " " + vehicle.cost_in_credits} type="vehicles" itemUrl={vehicle.url} colSpacing="col-4" />;
                    })}
            </div>
